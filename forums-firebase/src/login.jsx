  ...
  return (
    <div className="bg-gradient-to-r from-cyan-500 to-blue-500 w-full h-screen flex items-center justify-center">
      <div className="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl">
        <section>
          <h3 className="font-bold text-2xl">Welcome to the Login Page</h3>
        ...
        <section className="mt-10">
          <form className="flex flex-col" method="POST" onSubmit={handleSubmit}>
            ...
            <button className="bg-blue-600 hover:bg-blue-700 text-white mt-7 font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign In</button>
          </form>
        </section>
      </div>
      <div className="max-w-lg mx-auto text-center mt-12 mb-6">
        <p className="text-white">Don't have an account? <Link to="/signup" className="font-bold hover:underline">Sign up</Link>.</p>
        <Link to="/forgotpassword" className="text-sm text-blue-600 hover:text-blue-700 hover:underline mb-6">Forgot your password?</Link>
      </div>
    </div>
  );
}
