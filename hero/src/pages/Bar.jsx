...
const Bar = () => {
  return (
    <div className=" px-4 w-full pt-1">

      <div className="flex items-center h-12 w-[100%] ">
        <button className="flex justify-start items-center w-48 h-12 bg-white text-black px-4 pl-4 rounded-md border hover:bg-white focus:outline-none">
          <FaPlay className="mr-2 bg-purple-900 p-1" size={24} color='white' />
          Watch Demo
        </button>
        <form className="flex items-center  border-gray-300 p-1 rounded-full w-full">
          <input
