...
function Rightpanel({ setSecondChildHeight }) {
  ...
  return (
    <div className=" bg-gray-400 rounded-lg shadow-lg p-3  mx-auto"> {/*xl:w-[40%]*/}
      <div className="flex justify-between items-center">
        <div>
          <h3 className="text-3xl font-medium mb-2">It's a no Brainer</h3>
          <p className="text-black font-medium mb-4">Get Started Now</p>
        </div>
        <img src={qr} alt="hero" className="w-12 h-12" />
      </div>
      <div className="flex justify-between bg-gray-100 shadow-lg p-1 w-[100%] md:w-[100%] lg:w-[74vw]  " ref={secondChildRef}>
        <div className="flex-col min-w-[155px] mt-4">
          <h1 className="font-medium mb-2 mt-10 ml-1">Restarting S teps</h1>
        ...
        <div className="flex-col w-40 rounded-lg shadow-2xl border mb-3 mt-4 lg:min-w-28">
